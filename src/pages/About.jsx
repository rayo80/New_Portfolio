            ...
            <div className="container">
                ...
                <div className="about__info__items">
                    ...
                    <div className="about__info__item">
                        ...
                        <AboutInfoItem title="2013-2015" items={['junior developer ']}/>
                        <AboutInfoItem title="2015-2017" items={['Front end developer ']}/>
                        <AboutInfoItem title="2018-" items={['Freelance web Developer']}/>
                    </div>
                </div>
            </div>
            <ContactBanner/>
